        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="lg:col-span-2">
            ...
            <p className="text-secondary-foreground/80 leading-relaxed mb-6 max-w-md">
              Take the RIGHT STEP, Make the RIGHT CHOICE. Your trusted partner for global education, work, and travel opportunities.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3 flex flex-col">
              <Link to="/" className="text-secondary-foreground/80 hover:text-primary transition-colors duration-300">
                Home
              </Link>
              <Link to="/about" className="text-secondary-foreground/80 hover:text-primary transition-colors duration-300">
                About Us
              </Link>
              <Link to="/destinations" className="text-secondary-foreground/80 hover:text-primary transition-colors duration-300">
                Destinations
              </Link>
              <Link to="/success-stories" className="text-secondary-foreground/80 hover:text-primary transition-colors duration-300">
                Success Stories
              </Link>
              <Link to="/contact" className="text-secondary-foreground/80 hover:text-primary transition-colors duration-300">
                Contact Us
              </Link>
            </div>
          </div>
          ...
          <div>
            <h4 className="text-lg font-semibold mb-6 text-primary">Locations</h4>
